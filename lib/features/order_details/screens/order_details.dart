...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  void navToSearchScreen(String query) {
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 5),
                                Text(
                                  'Quantity: ${widget.order.quantities[i].toString()}',
                                  style: TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w500,
                                  ),
                ...
                child: Stepper(
                  ...
                  steps: [
                    ...
                    Step(
                      ...
                      content: const Text(
                        'Your order is yet to be shipped successfully',
                      ),
                    ...
                    Step(
                      title: const Text('Reached Hub'),
                      content: const Text(
                        'Your order will reached the nearest hub soon!',
                      ),
